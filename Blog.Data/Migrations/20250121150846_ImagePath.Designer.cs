...
namespace Blog.Data.Migrations
{
    ...
    [Migration("20250121150846_ImagePath")]
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "bea2df68-ebc3-43b3-be13-31a8900bd56c",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "576b079a-5624-4f0f-9844-269e7c7c403c",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "671c43ef-5a11-4536-ba22-b10b48e65325",
                            Name = "User",
                            NormalizedName = "NAME"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4b444669-57f9-463f-81e0-91eab8eb236e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEfpiKSBFEiVP5ahQPel7TTom0PYW0kuJ4azpR3Wcj2878GkRWbeQNGVOhZXqSFh+Q==",
                            PhoneNumber = "+9940506983552",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "ae3568ae-c209-445b-8af8-b344f67a4d06",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "da9aac94-ae3d-413c-b039-581cfe643b0d",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKSYjWrONtwxKebUJZIf4oIpZB0XRKNA7W6H9fzOzU0ODrMN8nV7H8xOjlIFxq6RDA==",
                            PhoneNumber = "+9940506983542",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5ee724e7-d522-477b-9221-954b300fd773",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("51da58b8-9bb8-4443-9167-b1caa26b74ed"),
                            ...
                            CreatedDate = new DateTime(2025, 1, 21, 19, 8, 45, 681, DateTimeKind.Local).AddTicks(9097),
                            ImageId = new Guid("7de25a1b-6c11-4aa3-9974-172c52571b2e"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("b79bdee5-af92-4512-8fb7-233974a97289"),
                            CategoryId = new Guid("e35e8b13-c92f-4720-bb44-bd0536925b08"),
                            Content = " VSLorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla a interdum sapien. Fusce eget lectus sit amet dui convallis feugiat nec et quam. Integer massa purus, dictum et vestibulum eget, ullamcorper ac diam. Cras varius sed eros in iaculis. Cras posuere dignissim purus nec porta. Phasellus vehicula at justo eu finibus. Mauris eget tempus nulla, vitae porta neque. Praesent in ornare magna. Phasellus diam dolor, consectetur ut eros id, feugiat aliquam turpis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ut tortor sit amet orci auctor pellentesque eget tristique augue. Aliquam et viverra tellus, ac hendrerit massa. Pellentesque rhoncus nisl non dolor tempor, malesuada convallis enim cursus. Aenean consequat ex dui, sed bibendum orci semper et.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 1, 21, 19, 8, 45, 681, DateTimeKind.Local).AddTicks(9114),
                            ImageId = new Guid("3a94e829-4a63-4598-8bd7-80aeda1eef6a"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 1, 21, 19, 8, 45, 682, DateTimeKind.Local).AddTicks(2726),
                            IsDeleted = false,
                            Name = "Asp.net Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 1, 21, 19, 8, 45, 682, DateTimeKind.Local).AddTicks(2735),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 1, 21, 19, 8, 45, 682, DateTimeKind.Local).AddTicks(3046),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2025, 1, 21, 19, 8, 45, 682, DateTimeKind.Local).AddTicks(3134),
